        ...
        <section className="hl-solution" id="solution">
          ...
          <div className="hl-steps">
            <div className="hl-step">
              ...
              <div className="hl-sbody">Default risk assessment for every deal, powered by 1.5M+ SBA 7(a) loans and 25 years of performance data. Probability of Default, Loss Given Default, and Expected Loss are all calculated per transaction in real time.</div>
            </div>
            <div className="hl-step">
              <div className="hl-snum">02</div>
              <div className="hl-stitle">Price</div>
              <div className="hl-sbody">Dynamically priced risk per transaction. Actuarial modeling that accounts for industry, geography, deal structure, and stress scenarios.</div>
            </div>
            <div className="hl-step">
