...
const NAV_DEFINITIONS = {
  borrower: [
    ...
    { id: 'valuation-engine', name: 'Value My Business',  href: '/dashboard/valuation-engine', icon: TrendingUp, always: false },
    { id: 'forecast',         name: 'Business Forecaster', href: '/dashboard/forecast',         icon: BarChart3,  always: false },
